...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Photo.category'
        db.delete_column('photo_photo', 'category_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Photo.category'
        db.add_column('photo_photo', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photo.PhotoCategory'], null=True, blank=True),
                      keep_default=False)
