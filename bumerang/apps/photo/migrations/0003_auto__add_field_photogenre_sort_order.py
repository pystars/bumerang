...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoGenre.sort_order'
        db.add_column('photo_photogenre', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PhotoGenre.sort_order'
        db.delete_column('photo_photogenre', 'sort_order')
