...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('photo_photocategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('photo', ['PhotoCategory'])

        # Adding model 'PhotoGenre'
        db.create_table('photo_photogenre', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('photo', ['PhotoGenre'])
        ...
        db.create_table('photo_photo', (
            ...
            ('original_file', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ...
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(max_length=255, to=orm['albums.PhotoAlbum'], null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photo.PhotoCategory'], null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(default=2011, null=True, blank=True)),
            ('genre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photo.PhotoGenre'], null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('photo_photocategory')

        # Deleting model 'PhotoGenre'
        db.delete_table('photo_photogenre')
    ...
    models = {
        ...
        'photo.photo': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['photo.PhotoCategory']", 'null': 'True', 'blank': 'True'}),
