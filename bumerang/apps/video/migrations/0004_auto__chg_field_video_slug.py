...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('video_video', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'Video.slug'
        db.alter_column('video_video', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
