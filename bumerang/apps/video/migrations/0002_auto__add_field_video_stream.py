...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.stream'
        db.add_column(u'video_video', 'stream',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.stream'
        db.delete_column(u'video_video', 'stream')
    ...
    models = {
        ...
        u'video.video': {
            ...
            'stream': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
