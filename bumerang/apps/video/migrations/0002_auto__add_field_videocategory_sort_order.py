...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoCategory.sort_order'
        db.add_column('video_videocategory', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VideoCategory.sort_order'
        db.delete_column('video_videocategory', 'sort_order')
