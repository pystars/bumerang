...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoCategory.sort_order'
        db.add_column('albums_photocategory', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PhotoCategory.sort_order'
        db.delete_column('albums_photocategory', 'sort_order')
    ...
    models = {
        ...
        'albums.photocategory': {
            'Meta': {'ordering': "('sort_order',)", 'object_name': 'PhotoCategory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'video.videocategory': {
            'Meta': {'ordering': "('sort_order',)", 'object_name': 'VideoCategory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
