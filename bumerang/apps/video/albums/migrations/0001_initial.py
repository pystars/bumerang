...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('albums_videoalbum', (
        ...
        db.send_create_signal('albums', ['VideoAlbum'])

        # Adding model 'PhotoAlbum'
        db.create_table('albums_photoalbum', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal('albums', ['PhotoAlbum'])

    def backwards(self, orm):
        # Deleting model 'VideoAlbum'
        db.delete_table('albums_videoalbum')

        # Deleting model 'PhotoAlbum'
        db.delete_table('albums_photoalbum')
