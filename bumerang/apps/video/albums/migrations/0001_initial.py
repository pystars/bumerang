...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'albums', ['PhotoAlbum'])

        # Adding model 'VideoAlbum'
        db.create_table(u'albums_videoalbum', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'albums_photocategory')

        # Deleting model 'PhotoAlbum'
        db.delete_table(u'albums_photoalbum')

        # Deleting model 'VideoAlbum'
        db.delete_table(u'albums_videoalbum')
