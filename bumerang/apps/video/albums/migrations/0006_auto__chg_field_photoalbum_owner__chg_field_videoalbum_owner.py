...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhotoAlbum.owner'
        db.alter_column(u'albums_photoalbum', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser']))

        # Changing field 'VideoAlbum.owner'
        db.alter_column(u'albums_videoalbum', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser']))

    def backwards(self, orm):

        # Changing field 'PhotoAlbum.owner'
        db.alter_column(u'albums_photoalbum', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'VideoAlbum.owner'
        db.alter_column(u'albums_videoalbum', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
