...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('converting_convertoptions', (
        ...
        db.send_create_signal('converting', ['ConvertOptions'])

    def backwards(self, orm):
        # Deleting model 'ConvertOptions'
        db.delete_table('converting_convertoptions')

    models = {
        'converting.convertoptions': {
