...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'playlists_channel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
        ))
        db.send_create_signal(u'playlists', ['Channel'])

        # Adding model 'PlayListItem'
        db.create_table(u'playlists_playlistitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'playlists', ['PlayListItem'])

        # Adding model 'PlayList'
        db.create_table(u'playlists_playlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playlists.Channel'])),
            ('rotate_from_date', self.gf('django.db.models.fields.DateField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'playlists', ['PlayList'])

        # Adding unique constraint on 'PlayList', fields ['channel', 'rotate_from_date']
        db.create_unique(u'playlists_playlist', ['channel_id', 'rotate_from_date'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlayList', fields ['channel', 'rotate_from_date']
        db.delete_unique(u'playlists_playlist', ['channel_id', 'rotate_from_date'])

        # Deleting model 'Channel'
        db.delete_table(u'playlists_channel')

        # Deleting model 'PlayListItem'
        db.delete_table(u'playlists_playlistitem')
