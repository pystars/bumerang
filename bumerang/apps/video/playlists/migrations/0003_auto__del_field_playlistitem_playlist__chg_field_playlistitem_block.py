...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlayListItem.playlist'
        db.delete_column(u'playlists_playlistitem', 'playlist_id')


        # Changing field 'PlayListItem.block'
        db.alter_column(u'playlists_playlistitem', 'block_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['playlists.PlayListBlock']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PlayListItem.playlist'
        raise RuntimeError("Cannot reverse this migration. 'PlayListItem.playlist' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'PlayListItem.playlist'
        db.add_column(u'playlists_playlistitem', 'playlist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playlists.PlayList']),
                      keep_default=False)


        # Changing field 'PlayListItem.block'
        db.alter_column(u'playlists_playlistitem', 'block_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playlists.PlayListBlock'], null=True))
    ...
    models = {
        ...
        u'playlists.playlistitem': {
            ...
            'block': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['playlists.PlayListBlock']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
