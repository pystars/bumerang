...
from bumerang.apps.messages.forms import ComposeForm
from bumerang.apps.messages.utils import format_quote
...
#            recipients = [u for u in User.objects.filter(id__in=[r.strip() for r in recipient.split('+')])]
