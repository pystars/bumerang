...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'messages_message', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.CustomUser']))

        # Changing field 'Message.sender'
        db.alter_column(u'messages_message', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser']))

    def backwards(self, orm):

        # Changing field 'Message.recipient'
        db.alter_column(u'messages_message', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Message.sender'
        db.alter_column(u'messages_message', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
