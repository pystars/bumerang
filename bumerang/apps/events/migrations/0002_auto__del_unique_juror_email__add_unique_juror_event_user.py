...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Juror', fields ['email']
        db.delete_unique('events_juror', ['email'])

        # Adding unique constraint on 'Juror', fields ['event', 'user']
        db.create_unique('events_juror', ['event_id', 'user_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Juror', fields ['event', 'user']
        db.delete_unique('events_juror', ['event_id', 'user_id'])

        # Adding unique constraint on 'Juror', fields ['email']
        db.create_unique('events_juror', ['email'])
