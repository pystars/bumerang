...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser']))

        # Changing field 'Juror.user'
        db.alter_column(u'events_juror', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser']))

        # Changing field 'Participant.owner'
        db.alter_column(u'events_participant', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser']))

        # Changing field 'ParticipantVideoScore.owner'
        db.alter_column(u'events_participantvideoscore', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser']))

    def backwards(self, orm):

        # Changing field 'Event.owner'
        db.alter_column(u'events_event', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Juror.user'
        db.alter_column(u'events_juror', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Participant.owner'
        db.alter_column(u'events_participant', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'ParticipantVideoScore.owner'
        db.alter_column(u'events_participantvideoscore', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
