...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.rules_document'
        db.alter_column('events_event', 'rules_document', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Event.rules_document'
        db.alter_column('events_event', 'rules_document', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
