...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BumTVBanner'
        db.create_table(u'banners_bumtvbanner', (
        ...
        db.send_create_signal(u'banners', ['BumTVBanner'])


    def backwards(self, orm):
        # Deleting model 'BumTVBanner'
        db.delete_table(u'banners_bumtvbanner')
    ...
    models = {
        ...
        u'banners.bumtvbanner': {
            'Meta': {'ordering': "['-sort_order', '-id']", 'object_name': 'BumTVBanner'},
