...
var ddimagepanner={
	...
	magnifyicons: ['http://www.waqss.de/images/navigation/zoom-plus.png','http://www.waqss.de/images/navigation/zoom-minus.png', 24,24], //set path to zoom in/out images, plus their dimensions
	...
	zoomfunct:function($, $img, s){
		...
		var $zoomimages=$('<a class="jmFullWall-ZoomIn" href="#">+</a><a class="jmFullWall-ZoomOut" href="#">-</a>')
			.css({opacity:0.7})
			.attr("title", "Zoom Out")
			.appendTo(s.$pancontainer)
			$zoomimages.eq(0).css({opacity:1}) //position "zoom in" image
			.attr("title", "Zoom In")
		$zoomimages.click(function(e){ //assign click behavior to zoom images
			...
			//s.$statusdiv.html(newzoom+"x").show() //show current zoom status/level
